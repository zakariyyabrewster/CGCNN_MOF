...
def load_test_results():
    ...
    for prop in properties:
        file_path = f'training_results/finetuning/Transformer/Trans_scratch_CoRE2019_1_{prop}/test_results_{prop}.csv'
...
def visualize_results(test_results, performance_df):
    ...
    plt.savefig('training_results/analysis/trans_6properties_analysis.png', dpi=300, bbox_inches='tight')
    plt.show()
...
def main():
    ...
    # Save results
    performance_df.to_csv('training_results/analysis/trans_6properties_performance.csv', index=False)
    comparison_df.to_csv('training_results/analysis/trans_6properties_comparison.csv', index=False)
